    ...
    <section className="relative py-32 bg-marine-500 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
        ...
        <Link 
          ...
          className="inline-block border-2 border-white text-white font-bold px-10 py-4 hover:bg-surface-500 hover:text-marine-800 transition-all text-sm tracking-widest"
        >
          GET INVOLVED NOW
        </Link>
      </div>
